...
<script src="changepassword/scriptforchange.js?v=<?php echo time()?>"></script>
    <div class="change-container">
        ...
        <label for="cur-password">Current Password : </label>
            <input type="password" id="cur-password" placeholder="Password" name="cur-password" >
        ...
        <div class="passchange">
            ...
            <input type="password" id="new-password" placeholder="Password" name="new-password" >
        ...
        <div class="passchange">
            ...
            <input type="password" id="con-password" placeholder="Password" name="password" >
        ...
        <div class="passchange">
            <div></div>
            <input onclick=""  type="submit" value="Change" class="submit-button">
            <div></div>
        </div>
