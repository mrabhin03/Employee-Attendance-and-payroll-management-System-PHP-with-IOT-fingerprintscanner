...
<script src="changepassword/scriptforchange.js?v=<?php echo time()?>"></script>
    <div class="change-container" >
        ...
        <label id="cur-passwordinvalid" style="color: red; margin: botton 20px;"></label>
        <div class="passchange">
            <label style="color: white;" for="new-password">New Password&ensp;&ensp;&ensp; : </label>
        ...
        <div class="passchange">
            <label style="color: white;" for="con-password">Confirm Password : </label>
